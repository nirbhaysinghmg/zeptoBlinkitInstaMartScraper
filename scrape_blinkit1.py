...
COORDINATES_CSV = "BangCords1.csv"  # CSV file containing coordinates
BASE_URL = "https://zeptoblinkitinstamartscraper-d4zi.onrender.com"  # FastAPI server URL
DELAY_BETWEEN_REQUESTS = 1  # Seconds to wait between requests
OUTPUT_DIR = "9JulyNoonHouseholds1"  # Directory to save output files
# =================================================

class BlinkitScraper:
    def __init__(self, base_url: str = "https://zeptoblinkitinstamartscraper-d4zi.onrender.com"):
...
def scrape_products_for_all_coordinates(queries: List[str], coordinates_data: List[Dict[str, str]], 
                                       base_url: str = "https://zeptoblinkitinstamartscraper-d4zi.onrender.com", 
