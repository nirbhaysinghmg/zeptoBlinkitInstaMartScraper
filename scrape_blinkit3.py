...
BASE_URL = "https://scraper3-lwsv.onrender.com"  # FastAPI server URL
DELAY_BETWEEN_REQUESTS = 1  # Seconds to wait between requests
OUTPUT_DIR = "9JulyNoonHousehold3"  # Directory to save output files
# =================================================

class BlinkitScraper:
    def __init__(self, base_url: str = "https://scraper3-lwsv.onrender.com"):
...
def scrape_products_for_all_coordinates(queries: List[str], coordinates_data: List[Dict[str, str]], 
                                       base_url: str = "https://scraper3-lwsv.onrender.com", 
